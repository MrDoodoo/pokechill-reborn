...
field.simpleAura = {
  info: function () {
    return `All of your Pokemon gain <strong data-ability="${ability.simple.id}" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("normal")}">${format(ability.simple.id)}</strong></strong>`;
  },
  tier: 1,
};
...
field.moodyAura = {
  info: function () {
    return `All of your Pokemon gain <strong data-ability="${ability.moody.id}" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("normal")}">${format(ability.simple.id)}</strong></strong>`;
  },
  tier: 1,
};
...
field.serendipity = {
  info: function () {
    return `Your hit effects are twice as likely to happen`;
  },
  tier: 1,
};
...
field.harshSun = {
  info: function () {
    return `Permanent <strong data-buff="sunny" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("fire")}">Sunny</strong></strong> weather`;
  },
  tier: 1,
};
...
field.thickFog = {
  info: function () {
    return `Permanent <strong data-buff="foggy" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("ghost")}">Foggy</strong></strong> weather`;
  },
  tier: 1,
};
...
field.fierceHail = {
  info: function () {
    return `Permanent <strong data-buff="hail" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("ice")}">Hail</strong></strong> weather`;
  },
  tier: 1,
};
...
field.coarseSandstorm = {
  info: function () {
    return `Permanent <strong data-buff="sandstorm" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("ground")}">Sandstorm</strong></strong> weather`;
  },
  tier: 1,
};
...
field.heavyRain = {
  info: function () {
    return `Permanent <strong data-buff="rainy" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("water")}">Rainy</strong></strong> weather`;
  },
  tier: 1,
};
...
field.mistyField = {
  info: function () {
    return `Permanent <strong data-buff="mistyTerrain" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("psychic")}">Misty Terrain</strong></strong> weather`;
  },
  tier: 1,
};
...
field.grassyField = {
  info: function () {
    return `Permanent <strong data-buff="grassyTerrain" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("grass")}">Grassy Terrain</strong></strong> weather`;
  },
  tier: 1,
};
...
field.electricField = {
  info: function () {
    return `Permanent <strong data-buff="electricTerrain" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("electric")}">Electric Terrain</strong></strong> weather`;
  },
  tier: 1,
};
...
field.trickField = {
  info: function () {
    return `Slower Pokemon become faster, faster Pokemon become slower`;
  },
  tier: 2,
};
...
field.reverseField = {
  info: function () {
    return `Type weaknesses and strengths are reversed`;
  },
  tier: 2,
  chance: 0.5,
};
...
field.averageTime = {
  info: function () {
    return `All moves execute at the default speed (2s)`;
  },
  tier: 2,
};
...
field.noMercy = {
  info: function () {
    return `Type-immune damage is now resisted instead of ignored`;
  },
  tier: 2,
};
...
field.deltaStream = {
  info: function () {
    return `Weather changes are disabled`;
  },
  tier: 3,
};
...
field.stealthRocks = {
  info: function () {
    return `Switching Pokemon deal damage`;
  },
  tier: 3,
};
...
field.heavyWeather = {
  info: function () {
    return `If an active team Pokemon typing does not match the current Weather, deal periodic damage`;
  },
  tier: 3,
};
...
field.ironBody = {
  info: function () {
    return `Super-effective damage on the enemy Pokemon is reduced to neutral`;
  },
  tier: 3,
};
...
field.wonderWard = {
  info: function () {
    return `Non super-effective damage dealt to the enemy is reduced by 80%`;
  },
  tier: 4,
};
...
field.weakeningCurse = {
  info: function () {
    return `Physical damage dealt to the enemy is halved`;
  },
  tier: 4,
};
...
field.fatiguingCurse = {
  info: function () {
    return `Special damage dealt to the enemy is halved`;
  },
  tier: 4,
};
...
field.firePledge = {
  info: function () {
    return `Pokemon with no Fire-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.fightingPledge = {
  info: function () {
    return `Pokemon with no Fighting-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.darkPledge = {
  info: function () {
    return `Pokemon with no Dark-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.dragonPledge = {
  info: function () {
    return `Pokemon with no Dragon-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.fairyPledge = {
  info: function () {
    return `Pokemon with no Fairy-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.rockPledge = {
  info: function () {
    return `Pokemon with no Rock-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.electricPledge = {
  info: function () {
    return `Pokemon with no Electric-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.steelPledge = {
  info: function () {
    return `Pokemon with no Steel-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.grassPledge = {
  info: function () {
    return `Pokemon with no Grass-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.waterPledge = {
  info: function () {
    return `Pokemon with no Water-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.IcePledge = {
  info: function () {
    return `Pokemon with no Ice-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.poisonPledge = {
  info: function () {
    return `Pokemon with no Poison-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.flyingPledge = {
  info: function () {
    return `Pokemon with no Flying-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.normalPledge = {
  info: function () {
    return `Pokemon with no Normal-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.bugPledge = {
  info: function () {
    return `Pokemon with no Bug-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.groundPledge = {
  info: function () {
    return `Pokemon with no Ground-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.ghostPledge = {
  info: function () {
    return `Pokemon with no Ghost-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
field.psychicPledge = {
  info: function () {
    return `Pokemon with no Psychic-type can't participate`;
  },
  tier: 4,
  chance: 0,
};
...
skill.ironWill = {
  info: function () {
    return `Increase Defense by 100% for 15 turns`;
  },
  effect: function () {
    moveBuff("wild", "defup2", undefined, 15);
  },
};

skill.ironSpirit = {
  info: function () {
    return `Increase Special Defense by 100% for 15 turns`;
  },
  effect: function () {
    moveBuff("wild", "sdefup2", undefined, 15);
  },
};

skill.omniboost = {
  info: function () {
    return `Increase all Stats by 50% for 10 turns`;
  },
  effect: function () {
    moveBuff("wild", "defup1", undefined, 10);
    moveBuff("wild", "sdefup1", undefined, 10);
    moveBuff("wild", "speup1", undefined, 10);
    moveBuff("wild", "atkup1", undefined, 10);
    moveBuff("wild", "satkup1", undefined, 10);
  },
};

skill.electroblast = {
  info: function () {
    return `Inflict ${tagParalysis} on your entire team for 10 turns`;
  },
  effect: function () {
    moveBuff("wild", "paralysis", "team", 10);
  },
};

skill.pyroblast = {
  info: function () {
    return `Inflict ${tagBurn} on your entire team for 15 turns`;
  },
  effect: function () {
    moveBuff("wild", "burn", "team", 15);
  },
};

skill.cryoblast = {
  info: function () {
    return `Inflict ${tagFreeze} on your entire team for 10 turns`;
  },
  effect: function () {
    moveBuff("wild", "freeze", "team", 15);
  },
};

skill.toxiblast = {
  info: function () {
    return `Inflict ${tagPoisoned} on your entire team for 15 turns`;
  },
  effect: function () {
    moveBuff("wild", "poisoned", "team", 15);
  },
};

skill.suddenDeath = {
  info: function () {
    return `Faints your currently active Pokemon`;
  },
  effect: function () {
...
areas.glisteringCaveI = {
  ...
  unlockRequirement: function () {
    return areas.vsUltraEntityLusamine.defeated;
  },
  icon: item.bugGem,
  spawns: {
...
areas.sunkenTempleI = {
  ...
  unlockRequirement: function () {
    return areas.vsPokemonProfessorOak.defeated;
  },
...
areas.vsGymLeaderBrock = {
  ...
  itemReward: {
    1: { item: item.hardStone.id, amount: 1 },
...
areas.vsGymLeaderMisty = {
  ...
  itemReward: {
    1: { item: item.mysticWater.id, amount: 1 },
...
areas.vsEliteTrainerCynthia = {
  ...
  itemReward: {
    1: { item: item.dragonFang.id, amount: 1 },
    2: { item: item.bottleCap.id, amount: 10 },
  },
  encounterEffect: function () {
    document.getElementById("tooltipTop").style.display = `none`;
...
areas.vsEliteFourLance = {
  ...
  itemReward: {
    1: { item: item.luckIncense.id, amount: 1 },
    2: { item: item.bottleCap.id, amount: 10 },
  },
  encounterEffect: function () {
    document.getElementById("tooltipTop").style.display = `none`;
...
areas.vsTeamLeaderGiovanni = {
  ...
  itemReward: {
    1: { item: item.abilityCapsule.id, amount: 3 },
    2: { item: item.bottleCap.id, amount: 10 },
  },
  encounterEffect: function () {
    document.getElementById("tooltipTop").style.display = `none`;
...
areas.vsMasterTrainerGeeta = {
  ...
  itemReward: {
    1: { item: item.autoRefightTicket.id, amount: 3 },
    2: { item: item.bottleCap.id, amount: 10 },
  },
...
areas.vsUltraEntityLusamine = {
  ...
  itemReward: {
    1: { item: item.autoRefightTicket.id, amount: 1 },
    2: { item: item.goldenBottleCap.id, amount: 10 },
  },
  encounterEffect: function () {
    document.getElementById("tooltipTop").style.display = `none`;
    document.getElementById("tooltipTitle").innerHTML =
...
areas.vsLegendTrainerAsh = {
  ...
  fieldEffect: [
    field.noMercy.id,
    field.neutralisingGas.id,
    field.deltaStream.id,
  ],
  reward: [item.autoRefightTicket, item.goldenBottleCap],
};
...
areas.dimensionPikachuGmax = {
  ...
  fieldEffect: [
    field.noMercy.id,
    field.stealthRocks.id,
    field.weakeningCurse.id,
  ],
...
areas.dimensionKyuremWhite = {
  ...
  skills: {
    3: skill.ironWill.id,
    2: skill.suddenDeath.id,
    1: skill.demoralisingRoar.id,
  },
};
